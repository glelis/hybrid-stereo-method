...
import photometric_stereo.rpsnumerics as rpsnumerics
import numpy as np
...
class RPS(object):
    ...
    def load_images(self, foldername=None, ext=None, scale=1.0):
        """
        Load images in the folder specified by the "foldername" that have extension "ext"
        :param foldername: foldername
        :param ext: file extension
        """
        self.M, self.height, self.width = psutil.load_images(foldername, ext, scale)

    def load_npyimages(self, foldername=None, scale=1.0):
        """
        Load images in the folder specified by the "foldername" in the numpy format
        :param foldername: foldername
        """
        self.M, self.height, self.width = psutil.load_npyimages(foldername, scale)
