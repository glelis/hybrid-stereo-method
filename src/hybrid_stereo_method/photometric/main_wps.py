"""Weighted Photometric Stereo main module."""
...
from hybrid_stereo_method.photometric.wps import (
    estimate_normals_argmax_lstsq_robust,
)
...
def main(parameters):
    ...
    if experiment_type == "hybrid":
        ...
        logging.info("Starting photometric stereo experiment")
    ...
    convert_image_array_to_fni(
        normals_with_confidence, os.path.join(output_path, "normal_map_with_residuals.fni")
    )
